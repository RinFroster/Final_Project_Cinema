                ...
                <div className="MainFooter">
                   <div className="row">
                        <div className="col-sm-4 col-xs-12">
                            ...
                            <div className="col-sm-6 col-xs-6 noPaddingLeft fontSizeP">
                   ...
                   <div className="row">
                        ...
                        <div className="col-sm-12 col-md-2 imgFooter">
